...
- (void)drawRect:(CGRect)rect {
    ...
    CGSize numberSize = [numberString sizeWithAttributes:@{NSFontAttributeName: font}];
    ...
    NSDictionary *attrsDictionary = [NSDictionary dictionaryWithObjectsAndKeys:self.font, NSFontAttributeName, self.textColor, NSForegroundColorAttributeName, [NSNumber numberWithFloat:1.0], NSBaselineOffsetAttributeName, nil];
...
- (void)setValue:(NSString *)inValue {
    ...
    if (self.hideWhenZero == YES && _value != nil && ([_value isEqualToString:@"0"] || [_value isEqualToString:@""])) {
        self.hidden = YES;
    } else {
        self.hidden = NO;
    }
...
- (CGSize)badgeSize {
    ...
    CGSize numberSize = [numberString sizeWithAttributes:attrsDictionary];
